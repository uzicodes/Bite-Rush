...
export default function MenuComponent() {
  ...
  const addToCart = async (product: Product) => {
    ...
    // ✅ Update Statistics (this is what was missing!)
    try {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* View Cart and Statistics Buttons */}
      <div className="fixed bottom-6 right-6 flex gap-4">
        ...
        <Link
          href="/statistics"
          className="bg-red-700 hover:bg-red-800 text-white font-bold py-3 px-6 rounded-full shadow-lg flex items-center"
        >
          Statistics
        </Link>
      </div>
