...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-100 flex items-center justify-center p-4 relative">
      {/* Background Image with 4% Blur */}
      <div
        className="absolute inset-0 bg-cover bg-center z-0"
        style={{
          backgroundImage: "url('/sign-in.jpg')", // Path to the background image in the public folder
          backgroundSize: 'cover', // Ensure the background image covers the screen
          backgroundPosition: 'center', // Center the image
          filter: 'blur(4px)', // Apply 4px blur effect for 4% blur
        }}
      ></div>

      {/* Form and content */}
      <div className="bg-[#d5f5e3] rounded-2xl shadow-xl p-8 w-full max-w-md z-10 relative">
